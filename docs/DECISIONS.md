...
| **D9** | **Stream filters** per job: sync all (default), exclude list, optional exclude app-cache streams | Avoid surprise `Zone.Identifier` copies |
| **D10** | **Compare review required by default**; optional auto-sync after compare | Prevent destructive mirror mistakes |
